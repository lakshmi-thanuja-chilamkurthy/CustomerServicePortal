...
public class CustomerController {
	...
	public List<String> registerUser(@RequestBody CustomerEntity signUp) {
		...
		if(customer.emailId!=null && customer.password!=null && customer.customername!=null && 
				customer.contactNo!=0 && customer.contactPreference!=null && customer.pan!=null) {
		...
		return list;
			...
			List<String> list = new ArrayList<String>();
			list.add("please enter mandatory fields");
			return list;
		}
